(function (global, factory) {
    ...
    */
    ...
    var _Component_components, _Component_initialized, _Component_listeners, _Component_observers, _Component_state, _Component_rootElement;
    class Component {
        get components() {
        ...
        set components(newComponents) {
            Object.entries(newComponents).forEach(([key, value]) => {
                ...
                if (__classPrivateFieldGet(this, _Component_components, "f").has(key)) {
                    (_a = __classPrivateFieldGet(this, _Component_components, "f").get(key)) === null || _a === void 0 ? void 0 : _a.destroy();
                }
        ...
        get displayName() {
            ...
            return displayName !== null && displayName !== void 0 ? displayName : name;
        }
        get listeners() {
        ...
        set listeners(newListeners) {
            Object.entries(newListeners).forEach(([key, value]) => {
                ...
                if (__classPrivateFieldGet(this, _Component_listeners, "f").has(key)) {
                    (_a = __classPrivateFieldGet(this, _Component_listeners, "f").get(key)) === null || _a === void 0 ? void 0 : _a.destroy();
                }
        ...
        get state() {
            return Object.assign({}, __classPrivateFieldGet(this, _Component_state, "f"));
        }
        set state(newState) {
            if (this.initialized) {
        ...
        constructor(rootElement, initialState = {}) {
            ...
            if (rootElement.hasAttribute('data-initial-state')) {
                try {
                    htmlInitialState = JSON.parse((_a = rootElement.dataset.initialState) !== null && _a !== void 0 ? _a : '');
                }
                catch (_b) {
            ...
            this.setState(Object.assign(Object.assign({}, htmlInitialState), initialState));
            this.initialize();
        ...
        setState(newState) {
            ...
            if (Object.keys(stateChanges).length > 0 || !this.initialized) {
                const nextState = Object.assign(Object.assign({}, previousState), stateChanges);
                ...
                if (process.env.NODE_ENV !== 'production') {
                    propTypesExports.checkPropTypes(stateTypes, nextState, 'state', displayName);
                }
    ...
    _Component_components = new WeakMap(), _Component_initialized = new WeakMap(), _Component_listeners = new WeakMap(), _Component_observers = new WeakMap(), _Component_state = new WeakMap(), _Component_rootElement = new WeakMap();

    function setAttributes(target, attributes) {
        Object.entries(attributes !== null && attributes !== void 0 ? attributes : {}).forEach(([key, value]) => {
            if (value === null) {
    ...
    function createMediaQueryListener(query, listener, options) {
...
//# sourceMappingURL=froyojs.js.map
